...
class astar:
    def __init__(self, map_width: int, map_height: int, costmap_vector, start, goal):
        self.visited = set()
        self.explored = set()
        self.visitedCost = {}
        ...
        # pygame is only needed for testiing
        # self.projectLoop()
    ...
    def map_to_int(self):
        ...
        # ask about this, this should be 310 for width right?
        # self.maze = np.array(cost_map_data).reshape(-1, 310).tolist()
        self.maze = np.array(cost_map_data).reshape(-1, self.width).tolist()
